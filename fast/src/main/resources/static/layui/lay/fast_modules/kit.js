...
layui
		.define(
				[ "layer", "utils" ],
				function(t) {
					var i = layui.jquery, a = i(window);
					utils = layui.utils, localStorage = utils.localStorage;
					var s = function() {
						this.config = {
							type : "TABS"
						}, this.version = "1.0.0"
					...
					s.prototype.set = function(t) {
						...
						e.tabsInit(this), e.toolsInit()
					};
					var e = {
						toolsInit : function() {
							var t = i('[kit-toggle="side"]');
									t
											.on(
													"click",
													function() {
														var a = i("div[kit-side]"), s = i("div[kit-body]"), e = i("div[kit-tabs-t]"), l = i("div[kit-footer]");
														switch (t
																.attr("data-toggle")) {
														case "on":
																	a
						...
						tabsInit : function(t) {
							if ("TABS" === t.config.type.toUpperCase()) {
								var a = i(".layui-layout-admin");
										a
												.append([
						...
						themeInit : function() {
							var t = localStorage
									.getItem("KITADMIN_SETTING_THEME");
							if (null !== t) {
								layui.utils.isString(t) && (t = JSON.parse(t));
								var a = t.theme, s = i("#theme").attr("href"), e = s
										.substr(0, s.lastIndexOf("/") + 1);
								i("#theme").attr("href", e + a + ".css");
								var l = i("body");
								l.hasClass("kit-theme-" + a)
										|| l.addClass("kit-theme-" + a)
							}
						}
					};
					t("kit", new s)
