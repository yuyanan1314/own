var mods = [
  ...
  'tabs', 'menu', 'route', 'utils', 'component', 'kit', 'app'
];
...
layui.define(mods, function(exports) {
   ...
   * 个人信息
   */
  app.post("/admin/get-own", {}, function(result) {
    var storage = window.sessionStorage;
    storage.setItem("own",JSON.stringify(result.data));
      layer.msg("登录成功");
      $('#loginname').text(result.data.username);
  });
    ...
    routeInit: function(config) {
      ...
      var routeOpts = {
        ...
        routes: [{
          ...
          path: '/cascader',
          component: 'views/cascader/own.html',
          name: 'Cascader'
        }, {
          path: '/',
          ...
          path: '/views/select',
          component: 'views/select/own.html',
          name: 'Select'
        }, {
          path: '/exception/403',
          component: 'views/exception/403.html',
